...
class Audio:
    ...
    def add_audio_and_transcribe(self):
        ...
        existing_audio = collection.find_one({'medical_record_number': self.medical_record_number})
        if not existing_audio:
            ...
            segments, _ = model.transcribe(self.audio_path, language='ur', task='transcribe')
